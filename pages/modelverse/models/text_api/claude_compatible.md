...
优云智算 平台提供了与 Anthropic Claude API 兼容的 **Messages** 接口，开发者可以使用 Anthropic SDK 或其他支持的工具直接调用 Modelverse 上的模型。
...
更多受支持的 Claude 兼容模型，请参考【获取模型列表】或访问 [UModelverse 模型中心](https://console.compshare.cn/light-gpu/model-center)。
